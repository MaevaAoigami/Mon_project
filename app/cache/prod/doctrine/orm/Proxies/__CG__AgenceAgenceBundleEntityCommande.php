 ...
 */
class Commande extends \Agence\AgenceBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'id', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'utilisateur', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'valider', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'date', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'reference', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\Commande' . "\0" . 'commande');
        }
