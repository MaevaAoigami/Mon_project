...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '80', 'dbname' => 'agence', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Agence\AgenceBundle\Twig\Extension\MontantTvaExtension A Agence\AgenceBundle\Twig\Extension\MontantTvaExtension instance.
     */
    protected function getMontanttvaService()
    {
        return $this->services['montanttva'] = new \Agence\AgenceBundle\Twig\Extension\MontantTvaExtension();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Agence\AgenceBundle\Listener\RedirectionListener A Agence\AgenceBundle\Listener\RedirectionListener instance.
     */
    protected function getRedirectionlistenerService()
    {
        return $this->services['redirectionlistener'] = new \Agence\AgenceBundle\Listener\RedirectionListener($this, $this->get('session'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '550a88adce6e8', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Agence\AgenceBundle\Services\GetFacture A Agence\AgenceBundle\Services\GetFacture instance.
     */
    protected function getSetnewfactureService()
    {
        return $this->services['setnewfacture'] = new \Agence\AgenceBundle\Services\GetFacture($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Agence\AgenceBundle\Services\GetReference A Agence\AgenceBundle\Services\GetReference instance.
     */
    protected function getSetnewreferenceService()
    {
        return $this->services['setnewreference'] = new \Agence\AgenceBundle\Services\GetReference($this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Agence\AgenceBundle\Twig\Extension\TvaExtension A Agence\AgenceBundle\Twig\Extension\TvaExtension instance.
     */
    protected function getTvaService()
    {
        return $this->services['tva'] = new \Agence\AgenceBundle\Twig\Extension\TvaExtension();
    }
