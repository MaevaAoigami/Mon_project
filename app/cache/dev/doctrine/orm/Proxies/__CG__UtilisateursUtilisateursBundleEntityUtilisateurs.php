...
class Utilisateurs extends \Utilisateurs\UtilisateursBundle\Entity\Utilisateurs implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'commande', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'adresses', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Utilisateurs' . "\0" . 'danseuse', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
