 ...
 */
class MediaEvent extends \Agence\AgenceBundle\Entity\MediaEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\MediaEvent' . "\0" . 'id', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\MediaEvent' . "\0" . 'name', '' . "\0" . 'Agence\\AgenceBundle\\Entity\\MediaEvent' . "\0" . 'path', 'file');
        }
